    ...
    <div class="col-7 col-sm-8 col-md-9 pl-0 pt-2">
      ...
      <div class="row">
        <div class="col-12 mb-3">
          <b-button :disabled="is_loading" variant="primary" class="btn-sm" type="button" @click.stop="addToCart">
            <i class="fa fa-cart-plus fa-lg" />
            Tambahkan ke Keranjang
          </b-button>
          <b-button :disabled="is_loading" variant="outline-primary" class="btn-sm" type="button" @click.stop="confirmRemove">
